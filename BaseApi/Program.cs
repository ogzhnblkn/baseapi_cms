...
try
{
    ...
    builder.Services.AddCors(options =>
    {
        options.AddPolicy(name: "BaseApiPolicy",
            policy =>
            {
                ...
                .AllowAnyMethod()
                .AllowCredentials()
                .WithExposedHeaders("Content-Disposition"); // File download i�in
            });
    });
        ...
        try
        {
            ...
            for (int i = 0; i < maxRetries; i++)
            {
                try
                {
                    ...
                    // **AUTO-MIGRATION EKLE - Hem local hem production i�in**
    ...
    // ** CONTACT RATE LIMITING MIDDLEWARE EKLEY�N - CORS'dan �NCE **
    ...
    app.Use(async (context, next) =>
    {
        // POST/PUT/DELETE istekleri i�in detayl� log
